...
const Home = () => {
  ...
  const handleSearch = () => {
    // Navigate to the MovieList page and pass the search query as part of the state
    navigate('/movies', { state: { query: searchQuery } });
  };
      ...
      <div className="home__row">
        ...
        <div className="home__movie">
          ...
          <div className="home__movieDetails">
            <h3 className="home__movieTitle">John Wick</h3>
            <p className="home__movieRating"> 8.7/10</p>
            <button className="home__bookButton" onClick={() => handleBook('John Wick', 'https://m.media-amazon.com/images/I/71tIm0Xxr2L._AC_UF1000,1000_QL80_.jpg')}>
              Book
            </button>
          </div>
        </div>
